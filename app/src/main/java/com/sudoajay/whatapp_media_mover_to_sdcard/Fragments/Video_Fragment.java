...
public class Video_Fragment extends Fragment {
    ...
    public  Video_Fragment createInstance(After_MainTransferFIle after_main_transferFIle, String which_Option_To_Do, List<File> selected_List
    , Context context)
    {
        Video_Fragment.after_main_transferFIle = after_main_transferFIle;
...
//        }
    ...
    public static void setMake_changes(Make_Changes make_changes) {
        Video_Fragment.make_changes = make_changes;
    }
    ...
    public void run_Selected(){
        ...
        if(which_Option_To_Do.equals("restore"))
            make_changes = new Make_Changes(after_main_transferFIle.getSd_Card_Path_URL() +whats_App_Media_Path +
                    whatsapp_Path.substring(1, whatsapp_Path.length()-1)+" Video");
        else
