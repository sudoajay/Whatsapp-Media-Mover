...
public class Profile_Fragment extends Fragment {
    ...
    , Context context)
    {
        Profile_Fragment.after_main_transferFIle = after_main_transferFIle;
    ...
    public void run_Selected(){
        ...
        if(which_Option_To_Do.equals("restore"))
            make_changes = new Make_Changes(after_main_transferFIle.getSd_Card_Path_URL()+whats_App_Media_Path +
                    whatsapp_Path.substring(1, whatsapp_Path.length()-1)+" Profile Photos",
                    after_main_transferFIle.getSd_Card_Path_URL()+whats_App_Media_Path+".Statuses",
                    after_main_transferFIle.getSd_Card_Path_URL()+whats_App_Media_Path+"/WallPaper");
        else
            make_changes = new Make_Changes(after_main_transferFIle.getExternal_Path_Url()+whats_App_Media_Path +
                    whatsapp_Path.substring(1, whatsapp_Path.length()-1)+" Profile Photos",
                    after_main_transferFIle.getExternal_Path_Url()+whats_App_Media_Path+".Statuses",
                    after_main_transferFIle.getExternal_Path_Url()+whats_App_Media_Path+"/WallPaper");
