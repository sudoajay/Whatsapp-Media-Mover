...
public class Sticker_Fragment extends Fragment {
    ...
    public Sticker_Fragment() {
        // Required empty public constructor
    }

    public Sticker_Fragment createInstance(After_MainTransferFIle after_main_transferFIle, String which_Option_To_Do, List<File> selected_List
            , Context context) {
        Sticker_Fragment.after_main_transferFIle = after_main_transferFIle;
