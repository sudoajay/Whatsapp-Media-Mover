...
import com.sudoajay.whatsapp_media_mover_to_sdcard.HelperClass.FileSize;
...
public class Dialog_InformationData extends DialogFragment implements View.OnClickListener {
    ...
    public Dialog_InformationData(final String path, final Activity activity) {
        this.path = path;
    ...
    private void SpecificFolder() {
        ...
        if (intent.resolveActivityInfo(activity.getPackageManager(), 0) != null) {
            ...
            CustomToast.ToastIt(activity, "No file explorer found");
        }
    }
}
